defmodule DateParser do
  ...
  def month(), do: "\\d{1,2}"
  def year(), do: "\\d{4}"
  def day_names(), do: "\\b(Mon|Tues|Wednes|Thurs|Fri|Satur|Sun)(day)\\b"
  def month_names(), do: "\\b(January|February|March|April|May|June|July|August|September|October|November|December)\\b"
